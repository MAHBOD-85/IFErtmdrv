...
; Not entirely certain how we can fix this in a sane manner
  .bank 2
  .org $D000
all_00_byte: .byte $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00

  .org $D040
all_FF_byte: .byte $FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF,$FF

  .org $D080
all_55_byte: .byte $55,$55,$55,$55,$55,$55,$55,$55,$55,$55,$55,$55,$55,$55,$55,$55
  .org $D0C0
...
timbre_sample_lut:
        ...
        .byte ((all_FF_byte - $C000) >> 6) & $ff ; sawtooth, ceiling
        .byte ((all_55_byte - $C000) >> 6) & $ff ; square, floor
        .byte ((all_55_byte - $C000) >> 6) & $ff ; square, ceiling
        .byte ((all_FF_byte - $C000) >> 6) & $ff ; triangle, starts ceiling and alternates
        .byte ((all_FF_byte - $C000) >> 6) & $ff ; triangle again
        .byte ((all_FF_byte - $C000) >> 6) & $ff ; triangle again
        .byte ((all_FF_byte - $C000) >> 6) & $ff ; triangle again
...
even_phase3:
        ...
        jmp done_picking_phase3 ; (3)
odd_phase3:
        lda #((all_00_byte - $C000) >> 6) & $FF
done_picking_phase3:
        sta $4012 ; (4)
        jmp restart_dmc
...
; Note: C8, Target Frequency: 2093.00, Actual Frequency: 2110.58, Tuning Error: 17.58
  ...
  .include "version_z/ifertmdrv/zsaw_nesasm_module/zsaw_pal.asm"
